(function () {
    NETWORK.GRAPH.LineChargeEdges = function (svg, edgesData) {
    ...
    NETWORK.GRAPH.LineChargeEdges.prototype.decorateEdges = function (svg, edgesData) {
        var gradient = svg.append("svg:defs").append("svg:linearGradient").attr({
            "x1": "0%",
            "y1": "0%",
            "x2": "100%",
            "y2": "0%",
        ...
        var offGradient = svg.append("svg:defs").append("svg:linearGradient").attr({
            "id": "LineChargeGradientOffStatus",
            "x1": "0%",
            "y1": "0%",
            "x2": "100%",
            "y2": "0%",
        ...
        this.edgeDecorator = svg.selectAll(".edgeCentre")
            ...
            .append("rect").attr({
                "class": "edgeDecorator lineChargeEdges",
                "x": 0,
                "y": 0,
            ...
            .style("fill", function (d) {
                if (parseInt(d.edgeData.status) === 0) {
                    return "url(#LineChargeGradientOffStatus)";
                } else {
                    if (svg.attr("id") === "svgGraph") {
