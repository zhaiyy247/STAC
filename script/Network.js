...
(function () {
        ...
        this.DataObjects = {
            ...
            branchDataObj: {
                "dataObjList": [{
                    ...
                    "solutionData": {
                        ...
                        "r": 0.065,
                        "ratio": 1,
                        "b": -1.5953682856223865,
                        "g": 0.16725635252492763,
                        "p-s-t": "51.3072",
                        "q-s-t": "10.0763",
                        "p-t-s": "-49.1456",
                        "q-t-s": "-34.9085",
                    ...
                    "solutionData": {
                        ...
                        "r": 0.025,
                        "ratio": 1,
                        "b": -1.3318534961154274,
                        "g": 0.044395116537180916,
                        "p-s-t": "-45.8545",
                        "q-s-t": "-19.9341",
                        "p-t-s": "46.5253",
                        "q-t-s": "-18.3140",
            ...
            busDataObj: {
                "dataObjList": [{
                    ...
                    "topDecorators": [{
                        "id": 1,
                        "helpDesc": "voltage controlled generator",
                        "type": "generator",
                        "text": "~",
                        "topDecoData": {
                            "bus": "1",
                    ...
                    "bottomDecorators": [{
                        "type": "shunt",
                        "helpDesc": "constant power load and a shunt element",
                        "Pd": "110.0",
                        "Qd": "40.0",
                        "Gs": "0.0",
                        "Bs": "0.0",
                        "DOMID": "bus1bottomDecoHelp"
                    }, {
                        "type": "load",
                        "helpDesc": "constant power load and a shunt element",
                        "Pd": "110.0",
                    ...
                    "topDecorators": [{
                        "id": 3,
                        "helpDesc": "synchronous condenser",
                        "type": "synCondensor",
                        "text": "c",
                        "topDecoData": {
                            "bus": "3",
                    ...
                    "bottomDecorators": [{
                        "type": "load",
                        "helpDesc": "constant power load",
                        "Pd": "95.0",
                        "Qd": "50.0",
                        "Gs": "0.0",
                        "Bs": "0.0",
                        "DOMID": "bus3bottomDecoHelp"
                    }],
                    "status": 1,
                    "solData": {"Va": -0.30136792180403804}
                }]
            },
            generatorCostDataObj: {
                "dataObjList": [{
                    "GenID": "2",
                    "startup": "0.0",
                    "shutdown": "0.0",
    ...
    NETWORK.Help.prototype.drawGraph = function () {
        ...
        var helpSvg = d3.select("body").append("svg").attr({
            "id": "helpSvgNode",
            "pointer-events": "all",
        }).on("dblclick.zoom", null);

        helpSvg.append('rect').attr({
            'class': 'backgroundHelp',
            'fill': 'wheat',
            'width': "100%",
            'height': "100%",
            "style": "stroke-width:4;stroke:grey"
        }).call(zoomHelp.on("zoom", redrawHelpWithDrag));

        //Appending help label after the rectangle because in the svg elements appear in the order in which they are appended.
        helpSvg.append('text').attr({
            'id': 'helpGraphLabel',
            'class': 'helpLabelText',
            'width': "100px",
            "x": "50",
        ...
        }).text("Mouseover an element for a description.");
